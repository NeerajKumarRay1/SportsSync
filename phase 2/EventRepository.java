...
public interface EventRepository extends JpaRepository<Event, UUID> {
     ...
     */
    @Query("SELECT e FROM Event e WHERE e.organizer.id = :organizerId AND e.status NOT IN ('CANCELLED', 'COMPLETED') ORDER BY e.eventDate ASC")
